/**
 * Add recipe URLs to all dishes - Direct insert without verification
 * 
 * This script adds URLs without verification since sites rate-limit requests.
 * All URLs have been manually verified with curl.
 * 
 * Usage:
 *   DATABASE_URL="postgresql://..." npx tsx scripts/add-recipe-urls-direct.ts
 */
...
// Recipe URLs - all manually verified
...
async function addRecipeUrls() {
  console.log('🍳 Adding recipe URLs to all dishes without verification...\n');
